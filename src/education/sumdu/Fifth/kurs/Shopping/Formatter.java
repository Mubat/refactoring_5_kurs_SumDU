...
public class Formatter {
    ...
    public String formatTicket(List<Item> items)
    {
        ...
        int    index = 0;
        for (Item item : items) {
            int discount = DiscountCalculating.calculateDiscount(item.getType(), item.getQuantity());
     ...
     */
    public void appendFormatted(StringBuilder sb, String value, int align, int width)
    {
